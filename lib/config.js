...
// Updates older than this (seconds) are replays of a backlog (webhook was down
// or unreachable), not live conversation. Enforcement must skip them: replayed
// messages arrive in a burst, so flood/burst scoring would false-flag normal
// users — this caused a mass false-ban incident on 2026-07-15.
export const STALE_UPDATE_THRESHOLD = 120;
...
const DEFAULTS = {
  ...
  FLOOD_THRESHOLD: 4,   // messages per FLOOD_WINDOW_MS before flood scoring
  BURST_THRESHOLD: 3,   // messages per BURST_WINDOW_MS before burst scoring
};
...
export const FLOOD_THRESHOLD = DEFAULTS.FLOOD_THRESHOLD;   // default; overridable via getThreshold()
export const BURST_WINDOW_MS = 3000;        // 3 seconds
export const BURST_THRESHOLD = DEFAULTS.BURST_THRESHOLD;   // default; overridable via getThreshold()
